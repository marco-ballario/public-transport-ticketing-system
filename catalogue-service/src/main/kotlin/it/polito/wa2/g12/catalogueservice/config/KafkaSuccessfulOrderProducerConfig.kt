...
import it.polito.wa2.g12.catalogueservice.kafka.SuccessfulOrderSerializer
...
@Configuration
class KafkaSuccessfulOrderProducerConfig(
    ...
    fun producerFactorySuccessfulOrder(): ProducerFactory<String, Any> {
        ...
        configProps[ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG] = SuccessfulOrderSerializer::class.java
